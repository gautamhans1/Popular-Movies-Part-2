...
import gautamhans.xyz.popularmovies.adapters.ReviewsAdapter;
import gautamhans.xyz.popularmovies.network.TMDbAPI;
import gautamhans.xyz.popularmovies.models.ReviewResult;
...
public class Reviews extends AppCompatActivity implements ReviewsAdapter.ReviewClickListener {
    ...
    private void loadReviews() {
        ...
        reviewsAPI.getReviews(Integer.parseInt(movie_id), getString(R.string.tmdb)).enqueue(new Callback<gautamhans.xyz.popularmovies.models.Reviews>() {
            @Override
            public void onResponse(Call<gautamhans.xyz.popularmovies.models.Reviews> call, Response<gautamhans.xyz.popularmovies.models.Reviews> response) {
            ...
            @Override
            public void onFailure(Call<gautamhans.xyz.popularmovies.models.Reviews> call, Throwable t) {
                t.printStackTrace();
                showNoReviews();
            }
        });
